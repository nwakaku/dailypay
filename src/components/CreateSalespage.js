...
function CreateSalespage({ provider }) {
  ...
  const isValid = (data) => {
    return (
      data.title && data.files.length > 0 && validAddress(data.paymentAddress)
    );
  };
  ...
  const create = async () => {
    ...
    try {
      ...
      const blob = new Blob([JSON.stringify({ streamId })], {
        ...
        <Col span={24}>
          <div>
            {/* <div className="centered create-detail"> */}
              <h1 className="centered">Book Order</h1>
            {/* </div> */}
          </div>
          <br />
        </Col>
        ...
        <Col span={24}>
          {!result && (
            <div className="create-form white boxed">
              ...
              <h3 className="vertical-margin">Payment Title:</h3>
              <Input
                placeholder="ENS/ Name of Vendor"
                value={data.title}
                prefix="Name: "
              ...
              <p>
                Enter payment address for this {APP_NAME}. Defaults to current
                address.
              </p>
              <Input
            ...
            <div>
              ...
              <Result
                ...
                extra={[
                  ...
                  <Button href={ipfsUrl(result.cid)} key="metadata">
                    View metadata
                  </Button>,
                  <Button href={result.contractUrl} key="contract">
                    View contract
                  </Button>,
                ]}
              />
          ...
          <div className="stages">
            ...
            >
              ...
              <Step
                ...
                description="Requires authorizing an invoice contract transaction."
              />
              <Step
                title="Done"
                description="Your Invoice will be live for others to view and confirm purchases."
              />
            </Steps>
          </div>
        </Col>
