...
import salespageLogo from '../assets/logo.png'
...
function Salespage({ account, provider, login, logout }) {
  ...
  return (<>
      <div className="centered salespage-header">
          ...
          <div><p>Purchase Page</p><br/>Add items to cart. Complete payment and get a proof of purchase receipt sent to your wallet.</div>
      </div>
